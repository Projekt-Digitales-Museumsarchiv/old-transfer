...
function df_offset($date){
	...
	$xWeeksAgoStr = df_translate('x weeks ago', "Vor %d Wochen");
	$xDaysAgoStr = df_translate('x days ago', "Vor %d Tagen");
	$todayStr = df_translate('Today',"Heute");
	$yesterdayStr = df_translate('Yesterday', "Gestern");
	$aWeekAgoStr = df_translate("a week ago", "Vor einer Woche");
	...
	return strftime("%d.%m.%Y",$date)." - ". $end;
}
/**
